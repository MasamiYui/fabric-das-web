...
public class CollegeEducationAsset extends BaseAsset{
    ...
    public CollegeEducationAsset(String id, String typeId, String title, String des, String submitTime, int state, String txId, String name, String sex, String birthOfDate, String educationType, String school, String major, String learnType, String lenOfSchooling, String dateOfAttendance, String dateOfGraduation, String bjy, String certificateNum) {
        super(id, typeId, title, des, submitTime, state, txId);
        this.name = name;
        this.sex = sex;
