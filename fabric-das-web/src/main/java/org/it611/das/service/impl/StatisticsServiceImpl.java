...
/*
    ...
    private HashMap combineData(HashMap map1, HashMap<String,Object> map2) {
        ...
        ((ArrayList)map1.get("syxxzlNum")).add(map2.get("syxxzlNum"));
        ((ArrayList)map1.get("drivingLicenceNum")).add(map2.get("drivingLicenceNum"));
        ...
        switch (assetState) {
            ...
            case "2":
                groupOperation = Aggregation.group()
                        ...
                        .sum("syxxzlNumUnPass").as("syxxzlNum")
